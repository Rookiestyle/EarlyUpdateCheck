  ...
  internal abstract class PluginUpdate
  {
    ...
    private static Dictionary<string, PluginUpdateInfo> GetLoadedPluginsName()
    {
      ...
      try
      {
        ...
        if (PluginList == null) PluginList = Tools.GetField("m_lPlugins", PluginManager);
    ...
    internal virtual bool Download(string sTempFolder)
    {
      ...
      bool bOK = DownloadFile(sFile, sTempFolder);
      if (bOK) return bOK;
      ...
      VersionAvailable = vVersionAvailableBackup;
      AllowVersionStripping = bAllowVersionStripping;
